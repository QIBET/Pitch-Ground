...
class PitchForm(FlaskForm):
    ...
    category = RadioField('Label', choices = [('Technology','Technology'), ('FashionPitch','FashionPitch'),('MotivationalPitch','Motivational'), ('Enterpreneuralpitch','Enterpreneuralpitch')],validators=[Required()])
